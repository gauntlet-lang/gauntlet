...
// DID: Break AccessorItem into two
...
// DID: Break AccessorCallData into two
(* and AccessorCallDataExprArgs = GenericsInstantiationData option * ExpressionCallArguments
and AccessorCallDataPipeArgs = GenericsInstantiationData option * PipeFunctionCallArguments *)
...
//and ModuleFunctionCallData<'T> = ModuleName * FunctionName * FunctionCallArguments<'T>
...
//and UnresolvedStructReference = UnresolvedStructReference of string
...
// Long structure for sure. Represents if, else-if, else
...
// type ScopesData = ScopeData list
...
type ASTData =
    { Functions: Map<string, FunctionData>
      ...
      //FieldsData: ASTFieldsAndFunctionsData
      Consts: Map<string, ConstData>
      //     Scopes: ScopeData list
      RawAST: AST
...
(* type ScopeTranspilers =
    { Expression: Expression -> Context -> string
      Declaration: NonToplevelDeclaration -> Context -> string
      Statement: Statement -> Context -> string } *)

//and Context = ASTData * ScopeTranspilers * ScopeData
